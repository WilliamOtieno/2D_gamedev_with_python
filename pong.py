...
wn = turtle.Screen()
wn.title("Pong By WilliamOtieno")
wn.bgcolor("black")
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player A: 0  Player B: 0", align="center", font=("Couruer", 16, "normal"))
...
while True:
    ...
    if ball.xcor() < -390:
        ...
        score_b += 1
        pen.clear()
        pen.write("Player A: {}  Player B: {}".format(score_a, score_b), align="center", font=("Couruer", 16, "normal"))
        os.system("aplay bounce.wav&")
